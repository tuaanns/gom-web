...
export const PaymentPackageModal = ({ isOpen, packageData, onClose, onSuccess, notify }) => {
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={isEditing ? t('admin.paymentPackagesPage.modal.editTitle') : t('admin.paymentPackagesPage.modal.addTitle')}
      size="sm"
    >
